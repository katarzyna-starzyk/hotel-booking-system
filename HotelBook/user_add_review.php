        ...
        <div class="container-fluid py-5">
            ...
            <div class="row bg-body-secondary justify-content-around align-items-center py-5">
                ...
                <form method="post" action="a_user.php">
                    <label for="rating" class="control-label">Oceń</label>
                    <input type="range" id="rating" name="rating" min="1" max="5"><br/>
                    <label for="review">Dodaj komentarz do recenzji:</label>
                    <input type="textarea" name="review"> 
                    <input type="hidden" name="bookingId" value=<?php echo $_GET['id'];?>> <br/>
                    <button type="submit" name="addRatingReview">Dodaj recenzję</button>
                </form>
